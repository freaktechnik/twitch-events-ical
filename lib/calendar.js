...
module.exports = class Calendar {
    ...
    formatEventDate(date) {
        return `${date.getUTCFullYear()}-${this.padNumber(date.getUTCMongth() + MONTH_OFFSET)}-${this.padNumber(date.getUTCDate())}T${this.padNumber(date.getUTCHours())}:${this.padNumber(date.getUTCMinutes())}-${this.padNumber(date.getUTCSeconds())}Z`;
    }
